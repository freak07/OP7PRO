...
export CLANG_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r365631/bin
...
export LD_LIBRARY_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r365631/lib64:$LD_LIBRARY_PATH
