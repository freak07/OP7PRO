...
export CLANG_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r377782b/bin
...
export LD_LIBRARY_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r377782b/lib64:$LD_LIBRARY_PATH
